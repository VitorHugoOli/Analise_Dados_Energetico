#### A tabela analisada possui 3 indexes Country(Paises), Product(Produtos) e Flow(Fluxos)
...
- Total : Total é igual ao total de produtos incluídos no conjunto de dados.
